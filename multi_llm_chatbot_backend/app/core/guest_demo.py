        ...
        deliverables = {
            ...
            "projects": {
                "p-demo-biz": {
                    ...
                    "sections": {
                        "overview": "Sample IR one-pager for demo org (80-person SMB).",
                        "background": "Triggered by client questionnaires asking for IR process.",
                        "methods": "Contain → eradicate → recover; preserve evidence; notify leadership.",
                        "results": "Draft contact tree and severity definitions in progress.",
                        "discussion": "Next: tabletop exercise with leadership in Q2.",
                    },
                    "versions": [],
                    "aiNotes": None,
                    "createdAt": int(now.timestamp() * 1000),
                ...
                "p-demo-policy": {
                    "id": "p-demo-policy",
                    "name": "Acceptable use outline",
                    "templateId": "cover-letter",
                    "sections": {
                        "header": "Acceptable Use Policy — draft outline",
                        "opener": "Purpose: protect company and client data.",
                        "body": "Cover devices, SaaS, MFA, prohibited sharing, incident reporting.",
                        "fit": "Aligned to CIS IG1 account & data protection themes.",
                        "close": "Owner: IT; review annually.",
                    },
                    "versions": [],
                    "aiNotes": None,
                    "createdAt": int(now.timestamp() * 1000),
